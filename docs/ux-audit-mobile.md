...
- **The label layer** was the single biggest readability problem — 210 uses of `text-[8px]`…`text-[11px]`, almost all uppercase at 0.2–0.35 em tracking. Fixed: an 11 px floor and a 0.08 em cap, everywhere but the admin console, the TV board and the share renderers.

...
- **Remaining**: the tile blurbs are 11 px where the 12 px meta token would be consistent — an 11 px literal rather than a `text-xs`, so PR 15's sweep did not reach it (F10).
- **Priority: Low.**

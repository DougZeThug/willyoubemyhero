-- Reordering used to be two separate updates from the client; a failure between
-- them left two stations sharing a station_order. One RPC makes it all-or-nothing.

      ...
      {phase != null && !reduced && (
        <>
          ...
          <button
            ...
            className="relative z-10 inline-flex min-h-11 items-center rounded-full border border-border-strong px-4 text-label font-bold uppercase tracking-[0.08em] text-muted-foreground outline-none hover:border-primary/50 hover:text-primary focus-visible:ring-2 focus-visible:ring-primary"
          >
            Skip
          </button>
        </>

        ...
        try {
          ...
          const row = await saveFn({
            data: {
              ...
              inputSnapshot: { ...item.input, masterPrompt: undefined },
  ...
  return (
    ...
    >
      ...
      <div className="mt-3 space-y-4">
              ...
              {players.map((ep) => (
                <div key={ep.id} className="rounded border border-white/10 p-2">
                  <label className="flex min-h-11 items-center gap-2">
                    ...
                    />
                    <span>{ep.participant?.name ?? "Unknown"}</span>
                  </label>
                  {selected.has(ep.id) && (
                    <Input
        ...
        <Button type="button" className="min-h-11 w-full" onClick={build}>
          Build Batch
        </Button>
        {current && (
          <div className="space-y-2 rounded border border-primary/30 p-3">
            ...
            <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
              ...
              <Button type="button" onClick={() => copyCurrent(false)}>
                Copy Prompt
              </Button>
              <Button type="button" onClick={() => copyCurrent(true)}>
                Copy & Next
              </Button>
              <Button
                type="button"
